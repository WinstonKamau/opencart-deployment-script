...
CREATE USER 'opencartuser'@'localhost' IDENTIFIED BY 'pointer12345';
GRANT ALL ON opencart.* TO 'opencartuser'@'localhost' IDENTIFIED BY '$OPEN_CART_PASSWORD' WITH GRANT OPTION;
FLUSH PRIVILEGES;
EOF
